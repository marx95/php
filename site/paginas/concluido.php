...
switch($id)
{
	case 1; die("<span id=\"Sucesso\">Sua conta foi criada, por&eacute;m, <b>foi enviado um email de confirma&ccedil;&atilde;o para " . $_GET['mail'] . "</b>. Em 10 Minutos voc&ecirc; receber&aacute; o email!</span>"); break;
