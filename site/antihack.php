<?php 
	...
	$crc_sv_maindll			= "476054187"; 	// <- Main.dll CRC VB6
	...
	switch($func)
	{
		case 0:
			...
			if($estreia_data_spt[0] < 8) die("#LoginTravado#Estrщia do MuOver#MuOver serс aberto dia 8, сs 14Horas!");
			if($estreia_data_spt[0] == 8)
			{
			...
			$Liberar = "#LoginLiberado#Main.exe#" . $server_ip . "#44405#";
			die($Liberar);
		break;
		case 1:
