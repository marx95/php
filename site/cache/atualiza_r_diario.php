<?php
	...
	$pagina = "
<div><input type=\"button\" onclick=\"carregar('paginas/premios.php','Centro','GET')\" value=\"Pr&ecirc;mio Top Di&aacute;rio\" \></div>
<table>
<tr><td colspan='7'>Top 50 Di&aacute;rio</td></tr>
</tr>
<tr>
<td width='25'>#</td>
...
<td><strong>Vip</strong></td>
	...
	$rank = 0;
	$result = mssql_query("SELECT TOP 50 accountid, name, class, clevel, resetsd from [$db_mssql].[dbo].[Character] WHERE resetsd > 0 AND ctlcode=0 order by resetsd desc, clevel desc");
...
";
	...
	<!-- Hora do Cache: $agora -->
	";
	EscreveCache("ranking/top_diario.html", $pagina);
?>