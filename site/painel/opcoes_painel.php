...
<td><input type="button" onclick="window.open('painel/avatar.php?personagem=<?php echo $personagem; ?>&login=<?php echo $login; ?>&senha=<?php echo md5($senha); ?>', '_blank', 'width=700,height=210,toolbar=no,location=no,resizable=no,directories=no,menubar=no,status=no'); return false;" value="Mudar Foto" /></td>
</tr>
<tr>
