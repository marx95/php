<?php
	...
	$pagina = "
<div><input type=\"button\" onclick=\"carregar('paginas/premios.php','Centro','GET')\" value=\"Pr&ecirc;mio MasterReset\" \></div>
<table>
<tr><td colspan='6'>Top 50 Master Resets</td></tr>
</tr>
<tr>
<td width='25'>#</td>
...
<td><strong>Vip</strong></td>
	...
	$rank = 0;
	$result = mssql_query("SELECT TOP 50 accountid, name, class, clevel, Mrs from [$db_mssql].[dbo].[Character] WHERE Mrs > 0 AND ctlcode=0 order by Mrs desc, clevel desc");
...
";
	...
	<!-- Hora do Cache: $agora -->
	";
	EscreveCache("ranking/top_mrs.html", $pagina);
?>