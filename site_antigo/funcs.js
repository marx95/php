function MudarTemplate(Padrao)
{
	var Valor = document.getElementById('Template').value;
	...
	Estilo.setAttribute("href", Valor + ".css");
	AjaxIMG = "ajax_" + Valor + ".gif";
	carregar('?f=1&Estilo=' + Valor, 'EstiloCookie','GET');
	
	setTimeout("Mostra('Caixa'); Mostra('Rodape'); Mostra('Banner');", 500);
}
function RankClasse()
{
